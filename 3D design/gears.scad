...
//#translate([10,0,0])pfeilrad (modul=Module, zahnzahl=10, breite=width, bohrung=bore, nabendicke=final_hub_thickness, nabendurchmesser=final_hub_diameter-1, eingriffswinkel=pressure_angle, schraegungswinkel=finalHelixAngle, optimiert=optimized);